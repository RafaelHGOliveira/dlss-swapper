...
internal class DLLManager : IDLLManager
{
    ...
    {
        return DLLPaths.GetExpectedDllFileName(dllRecord, isImported);
    }

    static string GetExpectedDllPath(DLLRecord dllRecord, bool isImported)
    {
        return DLLPaths.GetExpectedDllPath(dllRecord, isImported);
    }
    ...
    {
        return DLLPaths.DllNameForGameAssetType(gameAssetType);
    }
