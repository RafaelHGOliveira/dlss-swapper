...
{
    static IStoragePathProvider? _provider;
    static string? _storageRoot;

    public static void Initialize(IStoragePathProvider provider)
    {
        _provider = provider;
        _storageRoot = null; // reset cache

        // Create directories eagerly after initialization
    ...
    public static string StoragePath
    {
        get
        {
            ...
            {
                if (_provider is null) throw new InvalidOperationException("Storage not initialized. Call Storage.Initialize() first.");
                _storageRoot = _provider.GetStorageRoot();
